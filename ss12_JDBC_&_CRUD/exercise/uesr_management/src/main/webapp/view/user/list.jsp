...
<form action="/user?action=sort" method="post">
    <button class="btn btn-outline-primary mt-2">Sort</button>
</form>

<form class="d-flex">
    <input value="${country}" class="form-control me-2" type="text" placeholder="Enter Country" aria-label="Search"
           style="width: 200px" name="country">
