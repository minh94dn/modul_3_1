...
public class Customer {
    ...
    public Customer(int customerTypeId, String name, String dateOfBirth, boolean gender, String idCard, String phoneNumber, String email, String address, CustomerType customerType) {
